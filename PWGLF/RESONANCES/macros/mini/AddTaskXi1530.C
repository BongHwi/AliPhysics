/***************************************************************************
 ** Bong-Hwi Lim
 //Launches Xi1530 analysis with rsn mini package
...
AliRsnMiniAnalysisTask * AddTaskXi1530
(
 Bool_t      isMC=kFALSE,
 Bool_t      isPP=kTRUE,
 ...
 AliRsnCutSetDaughterParticle::ERsnDaughterCutSet cutXiCandidate=AliRsnCutSetDaughterParticle::kTPCpidTOFveto3s,
 Float_t     nsigmaXi=2.,
...
)
{
    ...
    if(!mgr){
        ::Error("AddTaskXi1530", "No analysis manager to connect to.");
        return NULL;
    }
    
    // create the task and configure
    TString taskName=Form("Xi1530%s%s_%i",(isPP? "pp" : "PbPb"),(isMC ? "MC" : "Data"),(Int_t)cutXiCandidate);
    ...
    ::Info("AddTaskXi1530", Form("Event mixing configuration: \n events to mix = %i \n max diff. vtxZ = cm %5.3f \n max diff multi = %5.3f", nmix, maxDiffVzMix, maxDiffMultMix));
    ...
    if(isPP && (!isMC) && cutVertex){
        ...
        ::Info("AddTaskXi1530", Form(":::::::::::::::::: Pile-up rejection mode: %s", (rejectPileUp)?"ON":"OFF"));
    }
    ...
    gROOT->LoadMacro("$ALICE_PHYSICS/PWGLF/RESONANCES/macros/mini/ConfigXi1530.C");
    if(!ConfigPhiPP13TeV_PID(task,isMC,isPP,"",cutsPair,aodFilterBit,customQualityCutsID,cutXiCandidate,nsigmaXi,enableMonitor,isMC&IsMcTrueOnly,monitorOpt.Data(),useMixLS,isMC&checkReflex,yaxisvar,polarizationOpt,triggerMask)) return 0x0;
    
    // -- CONTAINERS --------------------------------------------------------------------------------
    
    TString outputFileName = AliAnalysisManager::GetCommonFileName();
    //  outputFileName += ":Rsn";
    Printf("AddAnalysisTaskXi1530 - Set OutputFileName : \n %s\n",outputFileName.Data());
