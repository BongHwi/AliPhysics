...
void SystematicsTPC() {
  ...
  for (int iC = 0; iC < n_centralities; ++iC) {
    ...
    for (int iS = 0; iS < 2; ++iS) {
      ...
      // references_tpc[iC] = (TH1F*) references_tpc_tmp->Rebin(kNPtBins,Form("TPCspectra_%d",iC),pt_bin_limits);
      references_tpc[iC] = (TH1F*) references_tpc_tmp->Clone(Form("TPCspectra_%d",iC));
      ...
      // countsyst_tpc[iC] = (TH1F*)countsyst_tpc_tmp->Rebin(kNPtBins,Form("countsyst_tpc_%d",iC),pt_bin_limits);
      countsyst_tpc[iC] = (TH1F*) countsyst_tpc_tmp->Clone(Form("countsyst_tpc_%d",iC));
      ...
      matsyst_tpc[iC] = (TH1F*)matsyst_tmp->Rebin(kNPtBins,Form("hMatSyst_%d",iC),pt_bin_limits);
